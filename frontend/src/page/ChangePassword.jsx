...
const ChangePassword = () => {
    ...
    return (
        <div
            ...
            className="dark:bg-[#1A2236] dark:text-[#C6C8CD] flex flex-col items-center gap-8 pt-8"
        >
            ...
            >
                    ...
                    {oldPassword ? (
                        showOldPassword ? (
                            <GoEyeClosed
                                ...
                                className="select-none absolute right-3 top-[18px]"
                            />
                        ) : (
                            <RxEyeOpen
                                onClick={() => setShowOldPassword(!showOldPassword)}
                ...
                <button className="dark:bg-[#0A80FF] p-3 rounded-md w-80 font-semibold bg-[#0A80FF] text-white">
                    {status === "loading" ? (
                        <PulseLoader color="white" size={"0.5em"} />
                    ) : (
                        "Update"
                    )}
                </button>
